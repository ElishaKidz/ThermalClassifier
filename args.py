...
parser.add_argument('--train_datasets_names', type=str, default='kitti')
parser.add_argument('--val_datasets_names', type=str, default='kitti')
parser.add_argument('--test_datasets_names', type=str, default='kitti')
